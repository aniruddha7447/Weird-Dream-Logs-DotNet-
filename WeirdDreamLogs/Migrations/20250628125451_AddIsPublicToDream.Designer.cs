...
namespace WeirdDreamLogs.Migrations
{
    ...
    [Migration("20250628125451_AddIsPublicToDream")]
    partial class AddIsPublicToDream
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeirdDreamLogs.Models.FollowRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WeirdDreamLogs.Models.Follower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WeirdDreamLogs.Models.FollowRequest", b =>
                {
                    b.HasOne("WeirdDreamLogs.Models.User", "Requester")
                        .WithMany()
                        .HasForeignKey("RequesterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeirdDreamLogs.Models.User", "Target")
                        .WithMany()
            ...
            modelBuilder.Entity("WeirdDreamLogs.Models.Follower", b =>
                {
                    b.HasOne("WeirdDreamLogs.Models.User", "FollowedUser")
                        .WithMany()
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WeirdDreamLogs.Models.User", "FollowerUser")
                        .WithMany()
